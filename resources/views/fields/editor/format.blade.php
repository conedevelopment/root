<div class="editor__group">
    ...
    <button
        ...
        x-bind:class="{ 'btn--primary': isActive('underline', {}, updatedAt), 'btn--light': ! isActive('underline', {}, updatedAt) }"
        x-on:click="editor().chain().focus().toggleUnderline().run()"
    >
        <x-root::icon name="format-underline" class="btn__icon" />
    </button>
    <button
        type="button"
        class="btn btn--sm btn--icon"
    ...
    <button
        ...
        x-bind:class="{ 'btn--primary': isActive('highlight', {}, updatedAt), 'btn--light': ! isActive('highlight', {}, updatedAt) }"
        x-on:click="editor().chain().focus().toggleHighlight().run()"
    >
        <x-root::icon name="format-highlight" class="btn__icon" />
    </button>
    <button
        type="button"
